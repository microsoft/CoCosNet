...
- Run the command, note `dataset_path` is your ade20k root, e.g. `/data/Dataset/ADEChallengeData2016/images`. We use 8 32GB Tesla V100 GPUs to train framework. You can set `batchSize` to 16, 8 or 4 with fewer GPUs and change `gpu_ids`.
    ````
